...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/sale.order.line', methods=['GET'], type='http', auth='none',cors='*')
    @check_permissions
    def api__sale_order_line__GET(self, **kw):
    ...
    # Read one:
    @http.route('/api/sale.order.line/<id>', methods=['GET'], type='http', auth='none',cors='*')
    @check_permissions
    def api__sale_order_line__id_GET(self, id, **kw):
    ...
    # Create one:
    @http.route('/api/sale.order.line', methods=['POST'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/sale.order.line/<id>', methods=['PUT'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/sale.order.line/<id>', methods=['DELETE'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    @http.route('/api/sale.order.line/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
