...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/sale.order', methods=['GET'], type='http', auth='none',cors='*')
    @check_permissions
    def api__sale_order__GET(self, **kw):
    ...
    # Read one:
    @http.route('/api/sale.order/<id>', methods=['GET'], type='http', auth='none',cors='*')
    @check_permissions
    def api__sale_order__id_GET(self, id, **kw):
    ...
    # Create one:
    @http.route('/api/sale.order', methods=['POST'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/sale.order/<id>', methods=['PUT'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/sale.order/<id>', methods=['DELETE'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    @http.route('/api/sale.order/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
