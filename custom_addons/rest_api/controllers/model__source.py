...
# /api/utm.source                GET     - Read all (with optional filters, offset, limit, order)
# /api/utm.source/<id>           GET     - Read one
# /api/utm.source                POST    - Create one
# /api/utm.source/<id>           PUT     - Update one
# /api/utm.source/<id>           DELETE  - Delete one
# /api/utm.source/<id>/<method>  PUT     - Call method (with optional parameters)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/utm.source', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/utm.source/<id>', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/utm.source', methods=['POST'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/utm.source/<id>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/utm.source/<id>', methods=['DELETE'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    @http.route('/api/utm.source/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
