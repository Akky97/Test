...
# /api/stock.location                GET     - Read all (with optional filters, offset, limit, order)
# /api/stock.location/<id>           GET     - Read one
# /api/stock.location                POST    - Create one
# /api/stock.location/<id>           PUT     - Update one
# /api/stock.location/<id>           DELETE  - Delete one
# /api/stock.location/<id>/<method>  PUT     - Call method (with optional parameters)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/elshome.procurement.location', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/elshome.procurement.location/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/elshome.procurement.location', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/elshome.procurement.location/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/elshome.procurement.location/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/elshome.procurement.location/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
