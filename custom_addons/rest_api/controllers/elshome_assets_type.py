...
# /api/account.asset.category                GET     - Read all (with optional filters, offset, limit, order)
# /api/account.asset.category/<id>           GET     - Read one
# /api/account.asset.category                POST    - Create one
# /api/account.asset.category/<id>           PUT     - Update one
# /api/account.asset.category/<id>           DELETE  - Delete one
# /api/account.asset.category/<id>/<method>  PUT     - Call method (with optional parameters)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/elshome.asset.type', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    def api__elshome_elshome__GET(self, **kw):
        return wrap__resource__read_all(
            modelname='account.asset.category',
            default_domain=[],
    ...
    # Read one:
    @http.route('/api/elshome.asset.type/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/elshome.asset.type', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/elshome.asset.type/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/elshome.asset.type/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/elshome.asset.type/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
