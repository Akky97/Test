...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/bimabachat/sale_manager_team', method=['POST'], type='http', auth='none', csrf=False, cors='*')
            ...
            with registry.cursor() as cr:
                ...
                for z in m:
                    cr.execute("select t2.id,t3.name as salesperson,t2.login,t1.partner_name,t1.date_action,t1.name,t5.name as companyname, \
                      ...
                      where (to_date(to_char(t1.date_action, 'yyyy-mm-dd'), 'yyyy-mm-dd')) = (to_date(to_char(Now(), 'yyyy-mm-dd'), 'yyyy-mm-dd')) \
                      and not (t1.stage_id =27 or t1.stage_id =4) and t1.team_id ='" + str(z['id']) + "' \
                    ...
                    for id1 in alldata:
                        print(id1['pipelineid'], "IDDDSSS")
                        tbl += "<tr>"\
                               "<td style='border: 1px solid black'>" + str(id1['pipelineid']) + "</td>" \
                                ...
                                "<td style='border: 1px solid black'>" + str(id1['plannedrevenue']) + "</td>" \
                                "</tr>"
                    tbl += "</table>"
                    ...
                    li = z['login']
                    # li = z['login']
                    cc = "admin@bimabachat.in"
                    msg = MIMEMultipart('alternative')
                    msg['from'] = "info@bimabachat.in(Team SIL)"
                    msg['To'] = li
                    msg['cc'] = cc
                    print (msg['To'], "TO_msg")
                    msg['Subject'] = "TODAY ACTIVITIES"
                    rcpt = cc.split(",") + [li]
                    print (msg, "msg")
                    body = """ <html>
                                                                                                                                                                                                                                           <head></head>
                    ...
                    t1.id  as pipelineid,t4.name as subcategory ,t7.name as nextactivity,t8.name as stage,t1.date_deadline as deadline,t1.planned_revenue as plannedrevenue \
                                         from crm_lead as t1 \
                                          ...
                                          left join mail_message_subtype as t7 on t6.subtype_id=t7.id \
                                          left join crm_stage as t8 on t1.stage_id = t8.id \
                                          where t1.date_deadline  BETWEEN (to_date(to_char(NOW(),'yyyy-mm-dd'),'yyyy-mm-dd'))\
                                          and (to_date(to_char(Now(), 'yyyy-mm-dd'), 'yyyy-mm-dd') + interval '2 day') and \
                                           not (t1.stage_id =27 or t1.stage_id =4) and t1.active=True and t1.team_id = '" + str(z['id']) + "' \
                                          group by t2.login, t3.name,t1.partner_name,t1.date_action, t1.name, t2.id, t1.id, t4.name, t5.name, t7.name, t8.name, t1.date_deadline, t1.planned_revenue order by t3.name")
                    r1 = (cr.dictfetchall())
                    auth = json.dumps(r1)
                    alldata = json.loads(auth)
                    tbl = "<table style='border: 1px solid black'>" \
                          "<tr>" \
                          "<td style='border: 1px solid black'>PipelineId:</td>" \
                          "<td style='border: 1px solid black'>Next Activity Date</td>" \
                          "<td style='border: 1px solid black'>Opportunity</td>" \
                          "<td style='border: 1px solid black'>Customer</td>" \
                          "<td style='border: 1px solid black'>Company Name</td>" \
                          ...
                          "<td style='border: 1px solid black'>Next Activity</td>" \
                          "<td style='border: 1px solid black'>Stage</td>" \
                          "<td style='border: 1px solid black'>Expected Date</td>" \
                          "<td style='border: 1px solid black'>Expected Revenue</td>" \
                          "</tr>"
                    for id1 in alldata:
                        # if not id1['login']:
                    ...
                    body = """ <html>
                        ...
                        z['name']) + """</p>
                                                                                                                                                                                                                                                                                                                                <br>
                                                                                                                                                                                                                                                                                                                                <p>Please find the attachment at your Danger next activity </p>
                                                                                                                                                                                                                                                                                                                                <br>
                                                                                                                                                                                                                                                                                                                                <br>
                                                                                                                                                                                                                                                                                                                                <p>Please login into your bimabachat.in account to check the Pipeline  details.</p>
                                                                                                                                                                                                                                                                                                                                <br>
                                                                                                                                                                                                                                                                                                                                """ + tbl + """
                                                                                                                                                                                                                                                                                                                                <br>
                                                                                                                                                                                                                                                                                                                                <br>
                    ...
                    cr.execute("select t2.id,t3.name as salesperson,t2.login,t1.partner_name,t1.date_action,t1.name,t5.name as companyname, \
                                          ...
                                          left join mail_message_subtype as t7 on t6.subtype_id=t7.id \
                                          left join crm_stage as t8 on t1.stage_id = t8.id \
                                          where (to_date(to_char(t1.date_action,'yyyy-mm-dd'),'yyyy-mm-dd')) <  (to_date(to_char(Now(), 'yyyy-mm-dd'), 'yyyy-mm-dd')) and not (t1.stage_id =27 or t1.stage_id =4) and t1.active=True  and t1.team_id = '" + str(
                        z['id']) + "' \
                                          group by t2.login, t3.name, t1.date_action,t1.partner_name, t1.name, t2.id, t1.id, t4.name, t5.name, t7.name, t8.name, t1.date_deadline, t1.planned_revenue \
                                          order  by  t3.name ")
                    r1 = (cr.dictfetchall())
                    auth = json.dumps(r1)
                    alldata = json.loads(auth)
                    ...
                    for id1 in alldata:
                        tbl += "<tr><td style='border: 1px solid black'>" + str(id1['pipelineid']) + "</td>" \
                                    "<td style='border: 1px solid black'>" + id1['date_action'] + "</td>" \
                                    "<td style='border: 1px solid black'>" + id1['name'] + "</td>" \
                                    "<td style='border: 1px solid black'>" + str(id1['companyname']) + "</td>" \
                                    "<td style='border: 1px solid black'>" + str(id1['partner_name']) + "</td>" \
                                    "<td style='border: 1px solid black'>" + str(id1['subcategory']) + "</td>" \
                                    "<td style='border: 1px solid black'>" + str(id1['salesperson']) + "</td>" \
                    ...
                    msg['cc'] = cc
                    print (msg['To'], "TO_msg")
                    msg['Subject'] = "OVERDUE ACTIVITIES"
                    rcpt = cc.split(",") + [li]
                    print (msg, "msg")
                    body = """ <html>
                                                                                                                                                                                                                                             <head></head>
                    ...
                    cr.execute("select t2.id,t3.name as salesperson,t2.login,t1.partner_name,t1.date_action,t1.name,t5.name as companyname, \
                                         ...
                                         left join mail_message_subtype as t7 on t6.subtype_id=t7.id \
                                         left join crm_stage as t8 on t1.stage_id = t8.id \
                                         where t1.date_deadline  BETWEEN (to_date(to_char(NOW(),'yyyy-mm-dd'),'yyyy-mm-dd') +interval '3 day') \
                                         and (to_date(to_char(Now(), 'yyyy-mm-dd'), 'yyyy-mm-dd') + interval '5 day') \
                                         and not (t1.stage_id =27 or t1.stage_id =4) and t1.active=True and t1.team_id = '" + str(
                        z['id']) + "' \
                                         group by t2.login, t3.name,t1.partner_name,t1.date_action, t1.name, t2.id, t1.id, t4.name, t5.name, t7.name, t8.name, t1.date_deadline, t1.planned_revenue \
                                         order  by  t3.name ")
                    r1 = (cr.dictfetchall())
                    ...
                    msg['cc'] = cc
                    print (msg['To'], "TO_msg")
                    msg['Subject'] = "WARNING ACTIVITIES"
                    rcpt = cc.split(",") + [li]
                    print (msg, "msg")
                    body = """ <html>
                     <head></head>
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    <p>Hi """ + str(z['name']) + """</p>
                                                                                                                                                                                                                                                                                    <br>
                                                                                                                                                                                                                                                                                    <p>Please find the attachment at your Warning next activity </p>
                                                                                                                                                                                                                                                                                    <br>
                                                                                                                                                                                                                                                                                    <br>
                                                                                                                                                                                                                                                                                    <p>Please login into your bimabachat.in account to check the Pipeline details.</p>
                                                                                                                                                                                                                                                                                    <br>
