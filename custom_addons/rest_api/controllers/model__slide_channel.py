...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/channel', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    def api__res_partner__GET(self, **kw):
        return wrap__resource__read_all(
            modelname='slide.channel',
            default_domain=[],
    ...
    # Read one:
    @http.route('/api/channel/<id>', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/channel', methods=['POST'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/channel/<id>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/channel/<id>', methods=['DELETE'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    @http.route('/api/channel/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
