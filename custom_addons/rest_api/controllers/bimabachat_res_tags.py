...
# /api/res_partner_category                GET     - Read all (with optional filters, offset, limit, order)
# /api/res_partner_category/<id>           GET     - Read one
# /api/res_partner_category           cr     POST    - Create one
# /api/res_partner_category/<id>           PUT     - Update one
# /api/res_partner_category/<id>           DELETE  - Delete one
# /api/res_partner_category/<id>/<method>  PUT     - Call method (with optional parameters)
...
# /api/res_partner_category  POST  - Create one
# IN data:
#   HEADERS:
#       'access_token'
#   DEFAULTS:
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/bimabachat/res_partner_category', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/bimabachat/res_partner_category/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/bimabachat/res_partner_category', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/bimabachat/res_partner_category/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/bimabachat/res_partner_category/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/bimabachat/res_partner_category/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
