...
# /api/utm_campaign                GET     - Read all (with optional filters, offset, limit, order)
# /api/utm_campaign/<id>           GET     - Read one
# /api/utm_campaign           cr     POST    - Create one
# /api/utm_campaign/<id>           PUT     - Update one
# /api/utm_campaign/<id>           DELETE  - Delete one
# /api/utm_campaign/<id>/<method>  PUT     - Call method (with optional parameters)
...
# /api/utm_campaign  POST  - Create one
# IN data:
#   HEADERS:
#       'access_token'
#   DEFAULTS:
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/bimabachat/utm_campaign', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/bimabachat/utm_campaign/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/bimabachat/utm_campaign', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/bimabachat/utm_campaign/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/bimabachat/utm_campaign/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/bimabachat/utm_campaign/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
