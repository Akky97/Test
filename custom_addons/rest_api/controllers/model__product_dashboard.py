...
#           "results": [
OUT__product_template__read_all__JSON = (
    ...
    ('property_account_creditor_price_difference', (  # many2one
            'id',
            'name',
    )),
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/product.template', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    def api__product_template__GET(self, **kw):
    ...
    # Read one:
    @http.route('/api/product.template/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    def api__product_template__id_GET(self, id, **kw):
    ...
    # Create one:
    @http.route('/api/product.template', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/product.template/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/product.template/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/product.template/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
