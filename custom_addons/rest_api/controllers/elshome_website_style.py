...
# /api/product.style                GET     - Read all (with optional filters, offset, limit, order)
# /api/product.style/<id>           GET     - Read one
# /api/product.style                POST    - Create one
# /api/product.style/<id>           PUT     - Update one
# /api/product.style/<id>           DELETE  - Delete one
# /api/product.style/<id>/<method>  PUT     - Call method (with optional parameters)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/elshome.styles', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    def api__elshome_elshome__GET(self, **kw):
        return wrap__resource__read_all(
            modelname='product.style',
            default_domain=[],
    ...
    # Read one:
    @http.route('/api/elshome.styles/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/elshome.styles', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/elshome.styles/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/elshome.styles/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/elshome.styles/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
