...
OUT__project_issue__read_all__JSON = (  # editable
    ...
    #     'name',
    # )),
    ('x_category', [(  # many2many
            'id',
            'name',
    )]),
    ('x_subcategory', [(  # many2many
            'id',
            'name',
    )]),
)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/project.issue.new', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/project.issue.new/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/project.issue.new', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/project.issue.new/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/project.issue.new/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/project.issue.new/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
