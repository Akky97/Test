...
# /api/stock.location.route                GET     - Read all (with optional filters, offset, limit, order)
# /api/stock.location.route/<id>           GET     - Read one
# /api/stock.location.route                POST    - Create one
# /api/stock.location.route/<id>           PUT     - Update one
# /api/stock.location.route/<id>           DELETE  - Delete one
# /api/stock.location.route/<id>/<method>  PUT     - Call method (with optional parameters)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/elshome.route', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/elshome.route/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/elshome.route', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/elshome.route/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/elshome.route/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/elshome.route/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
