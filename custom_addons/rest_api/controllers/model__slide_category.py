...
# /api/slide.category                GET     - Read all (with optional filters, offset, limit, order)
# /api/slide.category/<id>           GET     - Read one
# /api/slide.category                POST    - Create one
# /api/slide.category/<id>           PUT     - Update one
# /api/slide.category/<id>           DELETE  - Delete one
# /api/slide.category/<id>/<method>  PUT     - Call method (with optional parameters)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/slide.category', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    def api__project_defect__GET(self, **kw):
        return wrap__resource__read_all(
            modelname='slide.category',
            default_domain=[],
    ...
    # Read one:
    @http.route('/api/slide.category/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/slide.category', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/slide.category/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/slide.category/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/slide.category/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
