...
#           "results": [
OUT__res_users__read_all__JSON = (
    # editable
    'id',
    'name',
    'login',
...
OUT__res_users__read_one__JSON = (  # editable
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/res.users2', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/res.users2/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/res.users2', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/res.users2/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/res.users2/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/res.users2/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
