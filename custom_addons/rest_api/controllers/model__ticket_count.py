...
# /api/ticket                GET     - Read all (with optional filters, offset, limit, order)
# /api/ticket/<id>           GET     - Read one
# /api/ticket                POST    - Create one
# /api/ticket/<id>           PUT     - Update one
# /api/ticket/<id>           DELETE  - Delete one
# /api/ticket/<id>/<method>  PUT     - Call method (with optional parameters)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/ticket.count', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/ticket.count/<id>', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/ticket.count', methods=['POST'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/ticket.count/<id>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/ticket.count/<id>', methods=['DELETE'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    @http.route('/api/ticket.count/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
