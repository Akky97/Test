...
# /api/product.product                GET     - Read all (with optional filters, offset, limit, order)
# /api/product.product/<id>           GET     - Read one
...
#           "results": [
OUT__product_product__read_all__JSON = (            # editable
    'id',
    'name',
)
#           ]
...
OUT__product_product__read_one__JSON = (            # editable
...
OUT__product_product__create_one__JSON = (          # editable
    'id',
)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/product.product', methods=['GET'], type='http', auth='none',cors='*')
    @check_permissions
    def api__product_product__GET(self, **kw):
        return wrap__resource__read_all(
            ...
            OUT_fields = OUT__product_product__read_all__JSON
        )
    
    # Read one:
    @http.route('/api/product.product/<id>', methods=['GET'], type='http', auth='none',cors='*')
    @check_permissions
    def api__product_product__id_GET(self, id, **kw):
        return wrap__resource__read_one(
            ...
            OUT_fields = OUT__product_product__read_one__JSON
        )
    
    # Create one:
    @http.route('/api/product.product', methods=['POST'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    def api__product_product__POST(self):
        return wrap__resource__create_one(
            ...
            OUT_fields = OUT__product_product__create_one__JSON
        )
    
    # Update one:
    @http.route('/api/product.product/<id>', methods=['PUT'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    def api__product_product__id_PUT(self, id):
    ...
    # Delete one:
    @http.route('/api/product.product/<id>', methods=['DELETE'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    def api__product_product__id_DELETE(self, id):
    ...
    @http.route('/api/product.product/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    def api__product_product__id__method_PUT(self, id, method):
        return wrap__resource__call_method(
            modelname = 'sale.order.lineproduct.product',
            id = id,
            method = method,
