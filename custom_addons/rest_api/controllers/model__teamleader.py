...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/crm.team.leader', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/crm.team.leader/<id>', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/crm.team.leader', methods=['POST'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/crm.team.leader/<id>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/crm.team.leader/<id>', methods=['DELETE'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    @http.route('/api/crm.team.leader/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
