...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/category', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/category/<id>', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/category', methods=['POST'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/category/<id>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/category/<id>', methods=['DELETE'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    @http.route('/api/category/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
