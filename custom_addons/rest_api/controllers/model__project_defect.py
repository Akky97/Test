...
# /api/project.defect                GET     - Read all (with optional filters, offset, limit, order)
# /api/project.defect/<id>           GET     - Read one
# /api/project.defect                POST    - Create one
# /api/project.defect/<id>           PUT     - Update one
# /api/project.defect/<id>           DELETE  - Delete one
# /api/project.defect/<id>/<method>  PUT     - Call method (with optional parameters)
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/project.defect', methods=['GET'], type='http', auth='none',cors='*')
    @check_permissions
    def api__project_defect__GET(self, **kw):
        return wrap__resource__read_all(
            modelname = 'project.defect',
            default_domain = [],
    ...
    # Read one:
    @http.route('/api/project.defect/<id>', methods=['GET'], type='http', auth='none',cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/project.defect', methods=['POST'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/project.defect/<id>', methods=['PUT'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/project.defect/<id>', methods=['DELETE'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
    ...
    @http.route('/api/project.defect/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False,cors='*')
    @check_permissions
