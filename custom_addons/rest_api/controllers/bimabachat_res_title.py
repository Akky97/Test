...
# /api/res_partner_title                GET     - Read all (with optional filters, offset, limit, order)
# /api/res_partner_title/<id>           GET     - Read one
# /api/res_partner_title           cr     POST    - Create one
# /api/res_partner_title/<id>           PUT     - Update one
# /api/res_partner_title/<id>           DELETE  - Delete one
# /api/res_partner_title/<id>/<method>  PUT     - Call method (with optional parameters)
...
# /api/res_partner_title  POST  - Create one
# IN data:
#   HEADERS:
#       'access_token'
#   DEFAULTS:
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/bimabachat/res_partner_title', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    def api__utm_source__GET(self, **kw):
        return wrap__resource__read_all(
            modelname='res.partner.title',
            default_domain=[],
    ...
    # Read one:
    @http.route('/api/bimabachat/res_partner_title/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/bimabachat/res_partner_title', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/bimabachat/res_partner_title/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/bimabachat/res_partner_title/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/bimabachat/res_partner_title/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
