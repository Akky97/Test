...
# /api/designation.designation                GET     - Read all (with optional filters, offset, limit, order)
# /api/designation.designation/<id>           GET     - Read one
# /api/designation.designation                POST    - Create one
# /api/designation.designation/<id>           PUT     - Update one
# /api/designation.designation/<id>           DELETE  - Delete one
# /api/designation.designation/<id>/<method>  PUT     - Call method (with optional parameters)
...
#           ...
# OUT data:
OUT__designation_designation__SUCCESS_CODE = 200  # editable
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/designation', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    def api__project_defect__GET(self, **kw):
        return wrap__resource__read_all(
            modelname='designation.designation',
            default_domain=[],
    ...
    # Read one:
    @http.route('/api/designation/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/designation', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/designation/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/designation/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/designation/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    def api__project_defect__id__method_PUT(self, id, method):
        return wrap__resource__call_method(
            ...
            id=id,
            method=method,
            success_code=OUT__designation_designation__SUCCESS_CODE
        )
