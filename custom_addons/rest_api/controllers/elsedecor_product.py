...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/elshome.product.template', methods=['GET'], type='http', auth='none', cors='*')
    ...
    # Read one:
    @http.route('/api/elshome.product.template/<id>', methods=['GET'], type='http', auth='none', cors='*')
    # @check_permissions
    ...
    # Create one:
    @http.route('/api/elshome.product.template', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    # @check_permissions
    ...
    # Update one:
    @http.route('/api/elshome.product.template/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    # @check_permissions
    ...
    # Delete one:
    @http.route('/api/elshome.product.template/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    # @check_permissions
    ...
    @http.route('/api/elshome.product.template/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    # @check_permissions
