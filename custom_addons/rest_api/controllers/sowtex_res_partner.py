...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/sowtex/res.partner.count', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Read one:
    @http.route('/api/sowtex/res.partner.count/<id>', methods=['GET'], type='http', auth='none' ,cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/sowtex/res.partner.count/<id>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/sowtex/res.partner.count/<id>', methods=['DELETE'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
    ...
    @http.route('/api/sowtex/res.partner.count/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False ,cors='*')
    @check_permissions
