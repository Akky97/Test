...
# /api/nature.nature                GET     - Read all (with optional filters, offset, limit, order)
# /api/nature.nature/<id>           GET     - Read one
# /api/nature.nature                POST    - Create one
# /api/nature.nature/<id>           PUT     - Update one
# /api/nature.nature/<id>           DELETE  - Delete one
# /api/nature.nature/<id>/<method>  PUT     - Call method (with optional parameters)
...
#           ...
# OUT data:
OUT__nature_nature__SUCCESS_CODE = 200  # editable
...
class ControllerREST(http.Controller):
    ...
    @http.route('/api/nature', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    def api__project_defect__GET(self, **kw):
        return wrap__resource__read_all(
            modelname='nature.nature',
            default_domain=[],
    ...
    # Read one:
    @http.route('/api/nature/<id>', methods=['GET'], type='http', auth='none', cors='*')
    @check_permissions
    ...
    # Create one:
    @http.route('/api/nature', methods=['POST'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Update one:
    @http.route('/api/nature/<id>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    # Delete one:
    @http.route('/api/nature/<id>', methods=['DELETE'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    ...
    @http.route('/api/nature/<id>/<method>', methods=['PUT'], type='http', auth='none', csrf=False, cors='*')
    @check_permissions
    def api__project_defect__id__method_PUT(self, id, method):
        return wrap__resource__call_method(
            ...
            id=id,
            method=method,
            success_code=OUT__nature_nature__SUCCESS_CODE
        )
