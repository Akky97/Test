...
class Brokeragereport(models.TransientModel):
    ...
    def generate_xlsx_report(self):
        ...
        return self.env['report'].get_action(self, report_name='clickbima.brok_comp_rep.xlsx', data=data)


from odoo.addons.report_xlsx.report.report_xlsx import ReportXlsx


class BrokerageReport(ReportXlsx):
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.write(6, 12, (''), bold1)
        sheet.write(6, 13, ('Brokerage'), bold1)
        sheet.write(6, 14, (''), bold1)

        sheet.write(6, 15, (''), bold1)
        sheet.write(6, 16, ('Third-party'), bold1)
        sheet.write(6, 17, (''), bold1)

        sheet.write(6, 18, (''), bold1)
        sheet.write(6, 19, ('Terrorism'), bold1)
        sheet.write(6, 20, (''), bold1)

        sheet.write(6, 21, ('Total'), bold1)

        sheet.write(6, 22, (''), bold1)
        sheet.write(6, 23, ('Reward'), bold1)
        sheet.write(6, 24, (''), bold1)

        sheet.write(6, 25, ('Stamp'), bold1)
        sheet.write(6, 26, ('Net'), bold1)
        ...
        sheet.write(7, 7, ('Start Date'), bold2)
        sheet.write(7, 8, ('Expiry Date'), bold2)
        sheet.write(7, 9, ('Insured Name'), bold)
        # sheet.write(7, 11, ('Insurer Name / Branch Name'), bold)
        sheet.write(7, 10, ('Sum Insured'), bold1)
        sheet.write(7, 11, ('Share(%)'), bold1)
        # sheet.write(7, 12, ('Premium'), bold1)
        sheet.write(7, 12, ('Premium'), bold1)
        sheet.write(7, 13, ('Brkg(%)'), bold1)
        sheet.write(7, 14, ('Commission'), bold1)

        sheet.write(7, 15, ('Premium'), bold1)
        sheet.write(7, 16, ('Brkg(%)'), bold1)
        sheet.write(7, 17, ('Commission'), bold1)

        sheet.write(7, 18, ('Premium'), bold1)
        sheet.write(7, 19, ('Brkg(%)'), bold1)
        sheet.write(7, 20, ('Commission'), bold1)



        sheet.write(7, 21, ('Brokerage'), bold1)

        sheet.write(7, 22, ('Premium'), bold1)
        sheet.write(7, 23, ('Brkg(%)'), bold1)
        sheet.write(7, 24, ('Commission'), bold1)

        sheet.write(7, 25, ('Duty'), bold1)
        sheet.write(7, 26, ('Premium'), bold1)
        ...
        if lines.groupby == 'create_date':
            ...
            total_brokerage = 0
            total_broprem = 0
            total_terr_brokerag = 0
            total_tp_brokerage = 0
            total_terr_brokerage = 0
            netprem_null = 0

            an_iterator12 = sorted(usr_detail, key=operator.itemgetter('create_date'))
            suminsur_null = 0
            gross_null = 0
            ...
            tp_commssionamt = 0
            terr_commssionamt = 0
            total_terr_commssionamt = 0
            total_tp_commssionamt = 0
            total_commssionamt = 0
            total_netcomm = 0
            total_tp_netcom = 0
            total_terr_netcom = 0
            total_commamt = 0
            total_commision_get = 0
            total_commssionamt = 0

            brokerage_pre = 0
            total_brokerage_pre = 0
            broprem_pre = 0
            total_broprem_pre = 0
            for res in an_iterator12:
                ...
                if res['commssionamt'] == None or res['commssionamt'] == False:
                    ...
                    commssionamt = res['commssionamt']

                if res['tp_commssionamt'] == None or res['tp_commssionamt'] == False:
                    tp_commssionamt = 0
                else:
                    tp_commssionamt = res['tp_commssionamt']

                if res['terr_commssionamt'] == None or res['terr_commssionamt'] == False:
                    terr_commssionamt = 0
                else:
                    terr_commssionamt = res['terr_commssionamt']

                if res['brokerage'] == None or res['brokerage'] == False:
                    brokerage = 0
                else:
                    brokerage = res['brokerage']

                if res['broprem'] == None or res['broprem'] == False:
                    broprem = 0
                else:
                    broprem = res['broprem']

                if res['terr_brokerage'] == None or res['terr_brokerage'] == False:
                    terr_brokerage = 0
                else:
                    terr_brokerage = res['terr_brokerage']

                if res['tp_brokerage'] == None or res['tp_brokerage'] == False:
                    tp_brokerage = 0
                else:
                    tp_brokerage = res['tp_brokerage']

                if res['brokerage'] == None or res['brokerage'] == False:
                    brokerage_pre = 0
                else:
                    brokerage_pre = res['brokerage']
                if res['broprem'] == None or res['broprem'] == False:
                    broprem_pre = 0
                else:
                    broprem_pre = res['broprem']
                ...
                total_terr_commssionamt += terr_commssionamt
                total_tp_commssionamt += tp_commssionamt
                total_commssionamt += commssionamt
                total_brokerage += brokerage
                total_broprem += broprem
                total_terr_brokerage += terr_brokerage
                total_tp_brokerage += tp_brokerage
                ...
                sheet.write(row, 7, res['startdate'], border)
                sheet.write(row, 8, res['enddate'], border)
                sheet.write(row, 9, res['insuredname'], border1)
                sheet.write(row, 10, suminsur_null, numbersformat)
                sheet.write(row, 11, res['co_share'], border2)
                sheet.write(row, 12, brokerage, numbersformat)
                sheet.write(row, 13, res['rate'], numbersformat)
                sheet.write(row, 14, commssionamt, numbersformat)

                sheet.write(row, 15, tp_brokerage, numbersformat)
                sheet.write(row, 16, res['tp_rate'], numbersformat)
                sheet.write(row, 17, tp_commssionamt, numbersformat)

                sheet.write(row, 18, terr_brokerage, numbersformat)
                sheet.write(row, 19, res['terr_rate'], numbersformat)
                sheet.write(row, 20, terr_commssionamt, numbersformat)

                sheet.write(row, 21, terr_commssionamt + commssionamt + tp_commssionamt, numbersformat)

                if res['endos_no'] != "":
                    sheet.write(row, 22, brokerage, numbersformat)
                    brokerage_pre = brokerage
                    total_brokerage_pre += brokerage_pre
                else:
                    sheet.write(row, 22, broprem, numbersformat)
                    total_brokerage_pre += broprem
                sheet.write(row, 23, res['rate1'], numbersformat)
                sheet.write(row, 24, res['commamt'], numbersformat)

                sheet.write(row, 25, res['stamprem'], numbersformat)
                sheet.write(row, 26, res['netprem'], numbersformat)
                row += 1
                index = index + 1
                totalbrokpremcount += totalbrokprem
                totalnetprems += netprem_null
                total_stamp += res['stamprem']
                total_commamt += res['commamt']
                total_commision_get += terr_commssionamt + commssionamt + tp_commssionamt
            sheet.write(row, 9, str(' Total'), bold2)
            sheet.write(row, 10, totalsuminsured, numbersformat1)
            sheet.write(row, 12, total_brokerage, numbersformat1)
            sheet.write(row, 14, total_commssionamt, numbersformat1)
            sheet.write(row, 15, total_tp_brokerage, numbersformat1)
            sheet.write(row, 17, total_tp_commssionamt, numbersformat1)
            sheet.write(row, 18, total_terr_brokerage, numbersformat1)
            # sheet.write(row, 19, total_terr_brokerage, numbersformat1)
            sheet.write(row, 20, total_terr_commssionamt, numbersformat1)
            sheet.write(row, 21, total_commision_get, numbersformat1)
            sheet.write(row, 22, total_brokerage_pre, numbersformat1)
            sheet.write(row, 24, total_commamt, numbersformat1)
            sheet.write(row, 25, total_stamp, numbersformat1)
            sheet.write(row, 26, totalnetprems, numbersformat1)
    ...
    def querys(self, workbook, data, lines, start_date, start_year, start_year1, end_date, end_year1, end_year, id=None,
        ...
        with registry.cursor() as cr:
            query = "select t1.brokerage,t1.rate,t1.commssionamt,t1.sertaxamt,netcomm," \
                    " t1.broprem,t1.rate1,t1.commamt,t1.sertaxamount,t1.netcommission," \
                    " terr_brokerage,t1.terr_rate,t1.terr_commssionamt,t1.terr_sertaxamt,t1.terr_netcomm," \
                    " t1.tp_brokerage,t1.tp_rate,t1.tp_commssionamt,t1.tp_sertaxamt,tp_netcomm,sum(t1.stamprem) as stamprem," \
                    " case when t8.co_insurer_id is not null then t8.co_share else 100 end as co_share," \
                    ...
                    " COALESCE(SUM(t1.tppremium),0) AS tp,COALESCE(SUM(t1.terrprem),0) AS tr,COALESCE(SUM(t1.stamprem),0) AS stamprem," \
            ...
            if lines.filterby == 'insurername':
                ...
                if lines.location != 'all':
                    ...
                    lines.insurer_name.name) + "')" \
                                               ...
                                               " t1.brokerage,t1.rate,t1.commssionamt,t1.sertaxamt,netcomm," \
                                               " t1.broprem,t1.rate1,t1.commamt,t1.sertaxamount,t1.netcommission," \
                                               " terr_brokerage,t1.terr_rate,t1.terr_commssionamt,t1.terr_sertaxamt," \
                                               " t1.terr_netcomm,t1.tp_brokerage,t1.tp_rate,t1.tp_commssionamt,t1.tp_sertaxamt,tp_netcomm,t1.stamprem"
                else:
                ...
                if lines.location != 'all':
                    query += " and t1.location = '" + str(lines.location) + "' AND (t3.name = '" + str(lines.insurer_name.name) + "' or t9.name = '" + str(
                        ...
                        lines.insurer_branch.name) + "') group by t8.co_insurer_id,t1.id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                                     ...
                                                     " t1.broprem,t1.rate1,t1.commamt,t1.sertaxamount,t1.netcommission," \
                                                     " terr_brokerage,t1.terr_rate,t1.terr_commssionamt,t1.terr_sertaxamt," \
                                                     " t1.terr_netcomm,t1.tp_brokerage,t1.tp_rate,t1.tp_commssionamt,t1.tp_sertaxamt,tp_netcomm"
                else:
                    query += " AND (t3.name = '" + str(lines.insurer_name.name) + "' or t9.name = '" + str(
                        lines.insurer_name.name) + "') AND (t2.name = '" + str(lines.insurer_branch.name) + "'" \
                                                                                                            "or t10.name = '" + str(
    ...
    def endos(self, workbook, data, lines, start_date, start_year, start_year1, end_date, end_year1, end_year, id=None,
        ...
        registry = Registry(db_name)
        with registry.cursor() as cr:
            query = " select sum(t1.brokerageprem) as brokerageprem,t1.rate,t1.sertaxamt,netcomm,sum(t8.endo_tp) as tp_brokerage,sum(t8.endo_stamp) as stamprem ,sum(t8.endo_terr) as terr_brokerage," \
                    " t1.broprem,t1.rate1,t1.commamt,t1.sertaxamount,t1.netcommission," \
                    " t1.terr_rate,t1.terr_commssionamt,t1.terr_sertaxamt,t1.terr_netcomm," \
                    " t1.tp_rate,t1.tp_commssionamt,t1.tp_sertaxamt,tp_netcomm," \
                    " '' as co_share,t3.name as insurername,t2.name as insurerbranch,t4.name as insuredname,t1.name as docketno," \
                    ...
                    " sum(t8.endos_brokerage_premium)  as brokerage,sum(t8.endo_commission) as commssionamt," \
            ...
            if lines.filterby == 'insurername':
                ...
                if lines.location != 'all':
                    query += " and t1.location = '" + str(lines.location) + "' AND t3.name = '" + str(lines.insurer_name.name) + "' " \
                                                                                  ...
                                                                                  " t1.brokerage,t1.rate,t1.commssionamt,t1.sertaxamt,netcomm," \
                                                                                  " t1.broprem,t1.rate1,t1.commamt,t1.sertaxamount,t1.netcommission," \
                                                                                  " terr_brokerage,t1.terr_rate,t1.terr_commssionamt,t1.terr_sertaxamt,t1.terr_netcomm,t1.stamprem," \
                                                                                  " t1.tp_brokerage,t1.tp_rate,t1.tp_commssionamt,t1.tp_sertaxamt,tp_netcomm"
                ...
                if lines.location != 'all':
                    query += " and t1.location = '" + str(lines.location) + "' and t8.endo_id is not null group by t8.name," \
                                                                            " t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom,t1.proposaldate,t2.name,t3.name," \
                                                                            " t4.name,t1.name,t5.name,t4.name,t7.name," \
                                                                            " t8.endo_tp,t8.endo_terr,t8.endo_stamp,t1.rate,t8.endos_manual, " \
                                                                            " t1.brokerage,t1.rate,t1.commssionamt,t1.sertaxamt,netcomm," \
                                                                            " t1.broprem,t1.rate1,t1.commamt,t1.sertaxamount,t1.netcommission," \
                                                                            " terr_brokerage,t1.terr_rate,t1.terr_commssionamt,t1.terr_sertaxamt," \
                                                                            " t1.terr_netcomm,t1.tp_brokerage,t1.tp_rate,t1.tp_commssionamt,t1.tp_sertaxamt,tp_netcomm,t1.stamprem"
...
BrokerageReport('report.clickbima.brok_comp_rep.xlsx', 'brokeragereport.report')
