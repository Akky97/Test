...
class Clientportfolio(models.TransientModel):
    _name = "clientportfolio.report"
    _description = "Client Portfolio Report"
    ...
    filterby = fields.Selection([('insurername', 'Insurer Name'), ('insurerbranch', 'Insurer Branch'), ('all', 'All'),('false', 'Individual'), ('true', 'Company'),('individual_client','Individual Client'),('individual_group','Individual Group'),('internal_reference','Internal Reference')],
    ...
    def generate_xlsx_report(self):
        ...
        return self.env['report'].get_action(self, report_name='clickbima.client_portfolio_report.xlsx', data=data)


from odoo.addons.report_xlsx.report.report_xlsx import ReportXlsx


class clientportfolio(ReportXlsx):
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.write(2, 0, ('Client Portfolio Report'), merge_format1)
        if lines.filterby == 'insurername':
        ...
        sheet.write(7, 2, ('IRDA Category'), bold2)
        sheet.write(7, 3, ('Type'), bold)
        sheet.write(7, 4, ('Insured Name/Group'), bold)
        sheet.write(7, 5, ('Scheme'), bold)
        sheet.write(7, 6, ('Policy No.'), bold1)
        sheet.write(7, 7, ('Ends No'), bold1)
        sheet.write(7, 8, ('Start Date'), bold2)
        sheet.write(7, 9, ('Expiry Date'), bold2)
        sheet.write(7, 10, ('Sum Insured'), bold1)
        sheet.write(7, 11, ('Co-Share'), bold2)
        sheet.write(7, 12, ('Brkg Prem'), bold1)
        sheet.write(7, 13, ('Other Prem'), bold1)
        sheet.write(7, 14, ('Net Premium'), bold1)
        ...
        if lines.groupby == 'create_date':
            ...
            an_iterator12 = sorted(usr_detail, key=operator.itemgetter('irda_cat'))
            new_lst = itertools.groupby(an_iterator12, key=operator.itemgetter('irda_cat'))
            for key, group in new_lst:
                ...
                for i in key_and_group.iteritems():
                    ...
                    for res in i[1]:
                        ...
                        sheet.write(row, 2, res['irda_cat'], border)
                        sheet.write(row, 3, res['policystatus'], border1)
                        sheet.write(row, 4, res['insuredname'], border1)
                        sheet.write(row, 5, res['subcategory'], border1)
                        sheet.write(row, 6, res['policyno'], border2)
                        sheet.write(row, 7, str(res['endos_no'] +str(',')+ res['endos_date']), border)
                        sheet.write(row, 8, res['startdate'], border)
                        sheet.write(row, 9, res['enddate'], border)
                        sheet.write(row, 10, suminsur_null, numbersformat)
                        sheet.write(row, 11,  res['co_share'], border)
                        sheet.write(row, 12, brokprem_null, numbersformat)
                        sheet.write(row, 13, (res['tp'] + res['tr'] + res['ts']), numbersformat)
                        sheet.write(row, 14, netprem_null, numbersformat)
                        row = row + 1
                        s_no = s_no + 1
                        index = index + 1
                    sheet.write(row, 9, str(i[0]) + str(' Total'), bold2)
                    sheet.write(row, 10, totalsuminsured, numbersformat1)

                    sheet.write(row, 12, totalbrokprem, numbersformat1)
                    sheet.write(row, 13, totalothersprems, numbersformat1)
                    sheet.write(row, 14, totalnetprem, numbersformat1)
                    row += 1
            ...
            sheet.write(row, 12, totalbrokpremcount, numbersformat1)
            sheet.write(row, 13, totalotherscount, numbersformat1)
            sheet.write(row, 14, totalnetprems, numbersformat1)
            row += 1
            ...
            sheet.write(row, 12, totalotherscount, numbersformat1)
            sheet.write(row, 13, totalnetprems, numbersformat1)
            row += 1
            print("Report Printed")
    ...
    def querys(self, workbook, data, lines, start_date, start_year, start_year1, end_date, end_year1, end_year, id=None,
        ...
        with registry.cursor() as cr:
            query = "select '' as endos_date, t20.irda_cat,case when t8.co_insurer_id is not null then t8.co_share else 100 end as co_share," \
                    ...
                    " left join category_category as t20 on t1.segment=t20.id"
            golbal = []
            dy_date = ''
            if lines.groupby == 'create_date':
                dy_date = 't1.date2'
            ...
            if lines.filterby == 'insurername':
                ...
                if lines.location != 'all':
                    query += " and t1.location = '" + str(lines.location) + "'"
                else:
                    query += "  AND (t3.name = '" + str(lines.insurer_name.name) + "' or t9.name = '" + str(
                        lines.insurer_name.name) + "')" \
                                                   ...
                                                   " t5.name,t4.name,t7.name,t1.tppremium,t1.terrprem,t1.stamprem,t1.rate,irda_cat"
                ...
                if lines.location != 'all':
                    ...
                    query += " AND (t3.name = '" + str(lines.insurer_name.name) + "' or t9.name = '" + str(
                        ...
                        lines.insurer_branch.name) + "') group by t8.co_insurer_id,t1.id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                                     " t1.proposaldate,t8.co_share,t8.co_type,t2.name,t3.name,t9.name,t10.name,t4.name,t1.name," \
                                                     " t20.irda_cat,t5.name,t4.name,t7.name,t1.tppremium , t1.terrprem , t1.stamprem,t1.rate"
                ...
                if lines.filterby == 'individual_client':
                    query += "  and t4.id = " + str(lines.client_name.id) + " " \
                                                                            "group by t8.co_insurer_id,t1.id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                                                            " t1.proposaldate,t8.co_share,t8.co_type,t2.name,t3.name,t9.name,t10.name,t4.name,t1.name," \
                                                                            " t5.name,t4.name,t7.name,t1.tppremium,t1.terrprem,t1.stamprem,t1.rate,t20.irda_cat"

                if lines.filterby == 'true':
                    query += "  and t4.is_company is  " + str(lines.filterby) + " " \
                                                                                 "group by t8.co_insurer_id,t1.id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                                                                 " t1.proposaldate,t8.co_share,t8.co_type,t2.name,t3.name,t9.name,t10.name,t4.name,t1.name," \
                                                                                 " t5.name,t4.name,t7.name,t1.tppremium,t1.terrprem,t1.stamprem,t1.rate,t20.irda_cat"

                if lines.filterby == 'internal_reference':
                    query += "  and t1.partner_internal = '" + str(lines.internal_reference) + "'" \
                                                                                               " group by t8.co_insurer_id,t1.id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                                                                               " t1.proposaldate,t8.co_share,t8.co_type,t2.name,t3.name,t9.name,t10.name,t4.name,t1.name," \
                                                                                               " t5.name,t4.name,t7.name,t1.tppremium,t1.terrprem,t1.stamprem,t1.rate,t20.irda_cat"

                if lines.filterby == 'individual_group':
                    query += "  and t1.group = '" + str(lines.group_name) + "'" \
                                                                            " group by t8.co_insurer_id,t1.id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                                                            " t1.proposaldate,t8.co_share,t8.co_type,t2.name,t3.name,t9.name,t10.name,t4.name,t1.name," \
                                                                            " t5.name,t4.name,t7.name,t1.tppremium,t1.terrprem,t1.stamprem,t1.rate,t20.irda_cat"

                if lines.filterby == 'false':
                    query += "  and t4.is_company is " + str(
                        lines.filterby) + "  group by t8.co_insurer_id,t1.id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                          " t1.proposaldate,t8.co_share,t8.co_type,t2.name,t3.name,t9.name,t10.name,t4.name,t1.name," \
                                          " t5.name,t4.name,t7.name,t1.tppremium,t1.terrprem,t1.stamprem,t1.rate,t20.irda_cat"
    ...
    def endos(self, workbook, data, lines, start_date, start_year, start_year1, end_date, end_year1, end_year, id=None,
        ...
        registry = Registry(db_name)
        with registry.cursor() as cr:
            query = " select t8.endos_date as endos_date,'' as co_share,t20.irda_cat,t3.name as insurername,t2.name as insurerbranch,t4.name as insuredname,t1.name as docketno," \
            ...
            if lines.filterby == 'insurername':
                ...
                if lines.location != 'all':
                    ...
                    query += "  AND t3.name = '" + str(lines.insurer_name.name) + "' " \
                                                                                  " and t8.endo_id is not null group by t8.name,t8.endos_date,t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                                                                  " t20.irda_cat,t1.proposaldate,t2.name,t3.name,t4.name,t1.name,t5.name,t4.name,t7.name,t8.endo_tp,t8.endo_terr,t8.endo_stamp,t8.endos_manual,t1.rate "
                ...
                if lines.location != 'all':
                    ...
                    query += " AND t3.name = '" + str(lines.insurer_name.name) + "'  AND t2.name = '" + str(
                        lines.insurer_branch.name) + "' and t8.endo_id is not null group by t8.endos_date,t8.name,t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom," \
                                                     " t20.irda_cat,t1.proposaldate,t2.name,t3.name,t4.name,t1.name,t5.name,t4.name,t7.name,t8.endo_tp,t8.endo_terr,t8.endo_stamp,t1.rate,t8.endos_manual"
                ...
                if lines.location != 'all':
                    query += " and t1.location = '" + str(lines.location) + "'"
                if lines.filterby == 'individual_client':
                    query += "  and t4.id = " + str(lines.client_name.id) + " and t8.endo_id is not null group by t8.endos_date,t8.name,t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom,t1.proposaldate,t2.name,t3.name," \
                         "  t20.irda_cat,t4.name,t1.name,t5.name,t4.name,t7.name,t8.endo_tp,t8.endo_terr,t8.endo_stamp,t1.rate,t8.endos_manual"


                if lines.filterby == 'true':
                    query += "  and t4.is_company is  " + str(lines.filterby) + " and t8.endo_id is not null group by t8.endos_date,t8.name,t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom,t1.proposaldate,t2.name,t3.name," \
                         "  t20.irda_cat,t4.name,t1.name,t5.name,t4.name,t7.name,t8.endo_tp,t8.endo_terr,t8.endo_stamp,t1.rate,t8.endos_manual"
                if lines.filterby == 'internal_reference':
                    query += "  and t1.partner_internal = '" + str(lines.internal_reference) + "' and t8.endo_id is not null group by t8.endos_date,t8.name,t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom,t1.proposaldate,t2.name,t3.name," \
                         "  t20.irda_cat,t4.name,t1.name,t5.name,t4.name,t7.name,t8.endo_tp,t8.endo_terr,t8.endo_stamp,t1.rate,t8.endos_manual"

                if lines.filterby == 'individual_group':
                    query += "  and t1.group = '" + str(lines.group_name) + "' and t8.endo_id is not null group by t8.endos_date,t8.name,t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom,t1.proposaldate,t2.name,t3.name," \
                         "  t20.irda_cat,t4.name,t1.name,t5.name,t4.name,t7.name,t8.endo_tp,t8.endo_terr,t8.endo_stamp,t1.rate,t8.endos_manual"
                if lines.filterby == 'false':
                    query += "  and t4.is_company is " + str(
                        lines.filterby) + " and t8.endo_id is not null group by t8.name,t8.endos_date,t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom,t1.proposaldate,t2.name,t3.name," \
                         "  t20.irda_cat,t4.name,t1.name,t5.name,t4.name,t7.name,t8.endo_tp,t8.endo_terr,t8.endo_stamp,t1.rate,t8.endos_manual"


                if lines.filterby == 'all':
                    query += " and t8.endo_id is not null group by t8.endos_date,t8.name,t8.endo_id,t1.policyno,t11.name,t1.date2,t1.expiry,t1.startfrom,t1.proposaldate,t2.name,t3.name," \
                             " t20.irda_cat,t4.name,t1.name,t5.name,t4.name,t7.name,t8.endo_tp,t8.endo_terr,t8.endo_stamp,t1.rate,t8.endos_manual "
...
clientportfolio('report.clickbima.client_portfolio_report.xlsx', 'clientportfolio.report')
