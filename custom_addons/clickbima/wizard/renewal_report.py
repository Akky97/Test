...
class Renewalreport(models.TransientModel):
    _name = "renewaldetail.report"
    _description = "Renewal Detail Report"
    ...
    def generate_xlsx_report(self):
        ...
        return self.env['report'].get_action(self, report_name='clickbima.renewal.xlsx', data=data)
...
class PartnerXlsx(ReportXlsx):
        def generate_xlsx_report(self, workbook, data, lines):
            ...
            report_head2 = 'Renewal Details for the period of Created Start Date : ' + str(
            ...
            sheet.write(6, 1, ('Docket No.'), bold2)
            sheet.write(6, 2, ('Policy No.'), bold)
            sheet.write(6, 3, ('Expiry Date'), bold2)
            sheet.write(6, 4, ('Sub Category'), bold)
            sheet.write(6, 5, ('Insured Name'), bold)
            sheet.write(6, 6, ('Sum Insured'), bold1)
            sheet.write(6, 7, ('Brok. Premium'), bold1)
            sheet.write(6, 8, ('Gross Premium'), bold1)
            sheet.write(6, 9, ('Insurer Name/Branch Name'), bold)
            sheet.write(6, 10, ('Renewal or Not'), bold)
            # sheet.write(6, 8, ('Payment Type/No'), bold)
            # sheet.write(6, 9, ('Co-Share'), bold1)
            sheet.write(6, 11, ('Source(Employee)/Medium(POS)'), bold)
            # sheet.write(6, 12, ('Net Premium'), bold1)
            # sheet.write(6, 13, ('Other Premium'), bold1)
            # sheet.write(6,413, ('Covernote No./Date'), bold1)
            # sheet.write(6, 14, ('Ends No./Date'), bold1)
            # sheet.write(6, 15, ('Start Date'), bold2)
            sheet.write(6, 12, ('Remarks/Vehicle No.'), bold)
            ...
            sheet.merge_range('A1:K1', report_head, merge_format1)
            sheet.merge_range('A4:M4', report_head2, merge_format)
            sheet.merge_range('A5:M5', report_head3, merge_format)
            sheet.merge_range('L1:M1', report_head4, bold3)
                             ...
                             for i in key_and_group.iteritems():
                                 ...
                                 for res in i[1]:
                                     ...
                                     if res['share'] == None or res['share'] == False:
                                         ...
                                         share = res['share']
                                     totalsuminsured += round(suminsur_null)
                                     totalbrokprem += round(brokprem_null)
                                     totalgrossprem += round(gross_null)
                                     totalnetprem += round(netprem_null)
                                     # sheet.write(row, 0, ' ', border1)
                                     sheet.write(row, 0, str(res['srno']) + str(' / ') + str(res['registersubno']),
                                                 borderdate)
                                     sheet.write(row, 1, res['docketno'], borderdate)
                                     sheet.write(row, 2, res['policyno'], borderdate)
                                     sheet.write(row, 3, res['enddate'], borderdate)
                                     sheet.write(row, 4, res['subcategory'], borderalpha)
                                     sheet.write(row, 5, res['clientname'], borderalpha)
                                     sheet.write(row, 6, suminsur_null, numbersformat)
                                     sheet.write(row, 7, brokprem_null, numbersformat)
                                     sheet.write(row, 8, gross_null, numbersformat)
                                     sheet.write(row, 9,
                                                 str(res['insurername']) + str(',  ') + str(res['insurerbranch']),
                                                 borderalpha)
                                     sheet.write(row, 10, res['renewal'], borderalpha)
                                     sheet.write(row, 11, str(res['event']) + str(',    ') + str(res['csc']),
                                                 borderalpha)
                                     sheet.write(row, 12, res['remark'], borderalpha)

                                     row = row + 1
                                     s_no = s_no + 1
                             sheet.write(row, 3, ('Created Date Total ') + i[0], bold2)
                             sheet.write(row, 4, (' '), bold1)
                             sheet.write(row, 5, (' '), bold1)
                             sheet.write(row, 6, totalsuminsured, numbersformat1)
                             sheet.write(row, 7, totalbrokprem, numbersformat1)
                             sheet.write(row, 8, totalgrossprem, numbersformat1)
                             row += 1
                             totalsuminsuredcount += totalsuminsured
                             totalbrokpremcount += totalbrokprem
                             totalgrosspremcount += totalgrossprem
                    sheet.write(row, 3, j[0] + str(' Total'), bold2)
                    sheet.write(row, 4, (' '), bold1)
                    sheet.write(row, 5, (' '), bold1)
                    sheet.write(row, 6, totalsuminsuredcount, numbersformat1)
                    sheet.write(row, 7, totalbrokpremcount, numbersformat1)
                    sheet.write(row, 8, totalgrosspremcount, numbersformat1)
                    row += 1
                        ...
                        for key, group in new_lst:
                            ...
                            for i in key_and_group.iteritems():
                                ...
                                for res in i[1]:
                                    ...
                                    row = row + 1
                                    s_no = s_no + 1
                            sheet.write(row, 3, ('Proposal Date Total ') + i[0], bold2)
                            sheet.write(row, 4, (' '), bold1)
                            sheet.write(row, 5, (' '), bold1)
                            sheet.write(row, 6, totalsuminsured, numbersformat1)
                            sheet.write(row, 7, totalbrokprem, numbersformat1)
                        ...
                        for key, group in new_lst:
                            ...
                            for i in key_and_group.iteritems():
                                ...
                                for res in i[1]:
                                    ...
                                    sheet.write(row, 7, brokprem_null, numbersformat)
                                    sheet.write(row, 8, gross_null, numbersformat)
                                    sheet.write(row, 9,str(res['insurername']) + str(',  ') + str(res['insurerbranch']),borderalpha)
                                    sheet.write(row, 10, res['renewal'], borderalpha)
                                    sheet.write(row, 11, str(res['event']) + str(',    ') + str(res['csc']),borderalpha)
                                    sheet.write(row, 12, res['remark'], borderalpha)
                                    row = row + 1
                                    s_no = s_no + 1
                            sheet.write(row, 3, ('Start Date Total ') + i[0], bold2)
                            sheet.write(row, 4, (' '), bold1)
                            sheet.write(row, 5, (' '), bold1)
                            sheet.write(row, 6, totalsuminsured, numbersformat1)
                            sheet.write(row, 7, totalbrokprem, numbersformat1)
        ...
        def querys(self, workbook, data, lines,start_date,start_year,start_year1,end_date,end_year1,end_year,id=None,endo=None):
                ...
                with registry.cursor() as cr:
                    query = "select sum(t1.tppremium + t1.terrprem + t1.stamprem) as otherprem,t1.date2 as docketdate," \
                            ...
                            " t1.ref as referby,t1.renewal_opt as renewal,t1.remark as remark, " \
                            " t1.startfrom as startdate,t1.expiry as enddate," \
                            " t8.name as location,t3.name as registername," \
                            " t11.name as clientname,t12.name as type,t1.policyno as policyno,t13.name as mode1," \
                    ...
                    if id != None and endo =='Table1' and id is not False:
                        query+="  ,t9.endos_date,t9.name as endos_no,'' as share,t9.endo_net as netprem ,t9.endos_brokerage_premium as brokprem,t9.endo_gst_gross as grossprem,t9.endos_suminsured as suminsured"
                    elif id != None and endo =='Table2' and id is not False:
                        query+= " ,'' as endos_date ,'' as endos_no,t21.name as insurername,t20.co_brokerage_pre as brokprem,t20.co_share as share,t20.co_sum_insured as suminsured ,t20.co_net_gross_pre as grossprem,t20.co_net_premium as netprem"
                    else:
                        query+= " ,'' as endos_date ,'' as endos_no,'' as share,t1.brokerageprem as brokprem, t1.grossprem as grossprem,t10.name as insurername,t1.suminsured as suminsured,t1.netprem as netprem"
                    ...
                    query+= " from policytransaction as t1 left join res_partner as t10 on t10.id=t1.insurername123" \
                            ...
                            " left join ptransaction1 as t15 on t15.name =t1.id  and t15.pay_of_id='policy'" \
                    ...
                    if lines.filterby == "registername":
                        ...
                        if id != None and endo == 'Table1'  and  id is not False:
                            query += " group by t9.name,t9.endos_date.t9.endos_brokerage_premium,t1.pipeline_id,t1.sale_order_id,t3.name,t10.name,t4.name,t5.name,t6.name,t1.date2,t7.name,t1.registername1,t8.name,t1.regsitersrno,t1.registersubno,t1.name,t1.proposaldate,t1.suminsured,t17.name,t1.ref,t13.name," \
                                     " t1.startfrom,t1.expiry,t11.name,t12.name,t1.remark,t1.policyno,t1.endo_ins,t1.coins,t1.renewal_opt,t1.id,t9.name,t9.endo_net,t9.endos_suminsured ,t9.endo_gst_gross  order by t3.name,t1.regsitersrno"
                            ...
                            query += " group by t20.co_net_gross_pre,t20.co_net_premium,t20.co_sum_insured,t20.co_brokerage_pre,t21.name,t20.co_share,t1.pipeline_id,t1.sale_order_id,t3.name,t4.name,t5.name,t6.name,t1.date2,t7.name,t1.registername1,t8.name,t1.regsitersrno,t1.registersubno,t1.name,t1.proposaldate,t1.suminsured,t17.name,t1.ref,t13.name," \
                                     " t1.startfrom,t1.expiry,t11.name,t12.name,t1.policyno,t1.remark,t1.endo_ins,t1.renewal_opt,t1.coins,t1.id order by t3.name,t1.regsitersrno"
                        else:
                            query += " group by t1.pipeline_id,t1.sale_order_id,t3.name,t10.name,t4.name,t5.name,t6.name,t1.date2,t7.name,t1.registername1,t8.name,t1.regsitersrno,t1.registersubno,t1.name,t1.proposaldate,t1.suminsured,t17.name,t1.ref,t13.name," \
                                     " t1.startfrom,t1.expiry,t11.name,t12.name,t1.policyno,t1.remark,t1.grossprem,t1.renewal_opt,t1.brokerageprem,t1.netprem,t1.endo_ins,t1.coins,t1.id order by t3.name,t1.regsitersrno"
                        cr.execute(query)
                        usr_detail = cr.dictfetchall()
                    ...
                    #     usr_detail = cr.dictfetchall()
                        ...
                        if id != None and endo == 'Table1'  and  id is not False:
                            query+=" group by t9.name,t9.endos_date,t9.endos_brokerage_premium,t1.pipeline_id,t1.sale_order_id,t3.name,t10.name,t4.name,t5.name,t6.name,t1.date2,t7.name,t1.registername1,t8.name,t1.regsitersrno,t1.registersubno,t1.name,t1.proposaldate,t1.suminsured,t17.name,t1.ref,t13.name," \
                                                               "t1.startfrom,t1.expiry,t11.name,t12.name,t1.policyno,t1.remark,t1.renewal_opt,t1.endo_ins,t1.coins,t1.id,t9.endos_date,t9.name,t9.endo_net,t9.endo_gst_gross,t9.endos_suminsured  order by t3.name,t1.regsitersrno"

                        elif id != None and endo == 'Table2'  and  id is not False:
                           query+=" group by t20.co_net_gross_pre,t20.co_net_premium,t20.co_brokerage_pre,t20.co_sum_insured,t20.co_share,t21.name,t1.pipeline_id,t1.sale_order_id,t3.name,t4.name,t5.name,t6.name,t1.date2,t7.name,t1.registername1,t8.name,t1.regsitersrno,t1.registersubno,t1.name,t1.proposaldate,t1.suminsured,t17.name,t1.ref,t13.name," \
                                     "t1.startfrom,t1.expiry,t11.name,t12.name,t1.policyno,t1.remark,t1.renewal_opt,t1.endo_ins,t1.coins,t1.id order by t3.name,t1.regsitersrno"
                        else:
                            query += " group by t1.pipeline_id,t1.sale_order_id,t3.name,t10.name,t4.name,t5.name,t6.name,t1.date2,t7.name,t1.registername1,t8.name,t1.regsitersrno,t1.registersubno,t1.name,t1.proposaldate,t1.suminsured,t17.name,t1.ref,t13.name," \
                                     " t1.startfrom,t1.brokerageprem,t1.expiry,t11.name,t1.remark,t12.name,t1.grossprem,t1.netprem,t1.policyno,t1.renewal_opt,t1.endo_ins,t1.coins,t1.id order by t3.name,t1.regsitersrno"
        ...
        def endos(self, workbook, data, lines,start_date,start_year,start_year1,end_date,end_year1,end_year):
            ...
            with registry.cursor() as cr:
                ...
                if lines.groupby == 'create_date':
                    ...
                    dy_date = 't1.date2'
                query ="select sum(t1.tppremium + t1.terrprem + t1.stamprem) as otherprem,t1.date2 as docketdate,t1.policyno as policyno, t1.registersubno as registersubno," \
                       " t1.regsitersrno as srno,t1.name as docketno, t1.pipeline_id as pipelineno,t1.sale_order_id as quotationno,t1.renewal_opt as renewal," \
                       " t1.proposaldate as proposaldate,t17.name as salesperson, t1.ref as referby,t1.remark as remark,  t1.startfrom as startdate,t1.expiry as enddate," \
                       " t8.name as location,t10.name as insurername,t3.name as registername, t11.name as clientname,t12.name as type, " \
                       " t13.name as mode1, t4.name as insurerbranch,t5.name as subcategory,t6.name as csc,t7.name as event, " \
                ...
                if lines.filterby == "registername":
                    ...
                    query += " group by t9.name,t9.endos_date,t1.pipeline_id,t1.sale_order_id,t3.name,t10.name,t4.name,t5.name,t6.name,t1.date2,t7.name,t1.registername1,t8.name,t1.regsitersrno,t1.registersubno,t1.name,t1.proposaldate,t1.suminsured,t17.name,t1.ref,t13.name," \
                                 " t1.startfrom,t1.expiry,t11.name,t12.name,t1.policyno,t1.remark,t1.renewal_opt,t9.endos_brokerage_premium,t1.endo_ins,t1.coins,t1.id,t9.endos_manual,t9.endo_net,t9.endos_suminsured ,t9.endo_gst_gross  order by t3.name,t1.regsitersrno"
                    cr.execute(query)
                    usr_detail = cr.dictfetchall()
...
PartnerXlsx('report.clickbima.renewal.xlsx', 'renewaldetail.report')
